...
export default async function JourneyDetailPage({
  ...
  return (
    <div className="mx-auto w-full max-w-3xl">
      ...
      {/* Header */}
      <div className="card-lg mt-5 p-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div className="min-w-0">
            <div className="flex flex-wrap items-center gap-2">
              <h1 className="font-heading text-2xl font-bold tracking-tight">{journey.route?.name ?? "—"}</h1>
              {journey.code && (
            ...
            <p className="ui mt-2 flex flex-wrap items-center gap-x-2 gap-y-1 text-sm font-medium text-slate-600 dark:text-zinc-300">
