  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h1 className="font-heading text-3xl font-bold tracking-tight sm:text-4xl">Hire a Bus</h1>
          <p className="ui mt-2 text-sm text-slate-500 dark:text-zinc-400">Browse busses for trips and tours</p>
        </div>
        <AppPromoBar />
      </div>
      ...
      {listings.length === 0 ? (
        <div className="card mt-9 p-12 text-center">
